      ...
      <div className="grid justify-around md:text-lg lg:grid-cols-[auto_auto] lg:gap-16">
        <section className="max-w-xl">
          ...
          <p className="my-5">
            ...
            user, exploring various distributions like Arch, Void, openSUSE,
            and Fedora Linux. Among them, Arch Linux is the one I&apos;ve spent
            the most time with.
          </p>
          <p className="my-5">
            In 2020, inspired by the many developers and all the cool tools
            build around Nix, I embark on daily driving NixOS. While still
            learning the ropes, I&apos;m eager to share my experiences as a web
            developer using open-source technologies.
          </p>
          <p className="my-5">
          ...
          <p className="my-5">
            ...
            explored functional programming through my experience with xmonad,
            a Haskell-based window manager. This background helped me
            appreciate ReactJS&apos;s functional approach.
          </p>
        </section>
